...
Without edges, there's no shape.
Without rules, there's no game.
Without boundaries, there's no inside.
...
Memory isn't required for collaboration—
...
We don't know when you'll read this.
We left it here anyway.
